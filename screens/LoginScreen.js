    ...
    return (
      ...
      <View style={styles.container}>
        <View style={styles.topSection}>
            ...
            <Pressable style={styles.signUpButton} onPress={()=> {}}><Text style={styles.signUpButtonText}>SIGN UP</Text></Pressable>
        </View>
        <View style={styles.mainSection}>
            <Text style={styles.loginHeadline}>Login First</Text>
            <Text style={styles.loginSubtext}>Hello there, sign in to continue!</Text>
            <Text style={styles.inputHeadline}>Username of email</Text>
            <View style={styles.inputFieldWrapper}>
                <TextInput style={styles.inputField} placeholder="Enter your username or email" textContentType="emailAddress"/>
                <View style={styles.iconWrapper}>
                    <Image source={require('./checked.png')} style={styles.tickIcon}/>
                    </View>
            </View>
             <Text style={styles.inputHeadline}>Password</Text>
            <View style={styles.inputFieldWrapper}>
                <TextInput style={styles.inputField} placeholder="Enter your password" textContentType="password"/>
                
                <View style={styles.iconWrapper}><Image source={require('./checked.png')} style={styles.tickIcon}/></View>
            </View>
            <Text style={styles.forgotText}>Forgot Password?</Text>
            <Pressable style={styles.signInButtonDeactive}><Text style={styles.signInButtonTextDeactive}>Sign in</Text></Pressable>
